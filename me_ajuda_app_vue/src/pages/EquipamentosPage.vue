<template>
  <q-page class="bg-white q-pa-md">
    <div class="text-h5 text-weight-bold text-center q-mb-md text-grey-9">
      Equipamentos
    </div>
    ...
    <div v-else class="q-pb-xl">
      ...
      >
        <q-card-section>
          ...
          <div class="text-subtitle2 text-weight-medium text-grey-8 q-mt-xs">
            ID: {{ item.id }}
          </div>
...
const handleDelete = async (id) => {
  try {
    ...
    // Atualiza a lista filtrando o item removido
